...
#pragma region 언더플로우
	...
	// 언더플로우는 최솟값보다 더 작은 값을 저장하게 괴면 최댓값부터
...
#pragma region 실수를 저장하는 방법
	...
	//printf("attack 변수의 값 : %.16lf\n", health);

	// <실수 형태의 10 진수를 2진수로 변환하는 과정>
...
#pragma region 관계 연산자
	...
	//    int result3 = 10 >= 5; // 10 >= 5 : 10이 5보다 크거나 같다. (참)
	 //   int result4 = 10 <= 5; // 10 <= 5 : 5보다 10보다크거나 같다. (거짓) 
...
#pragma region swich문
	...
	//default: printf("잘못된 값이 들어왔습니다.\n");
		// swich문은 해당 조건이 완료되었을 때, break 문이 없으면
		// 나머지 밑에 있는 case 분까지 계속 실행시키다가 종료합니다.
}

// swich문의 경우 조건에 해당하는 값에 따라
// 조건의 위치로 이동합니다.
//float time = 5.75f;
//
//swich (time)
//{
//	case 5.75: frint("time : %d", time);
//}

//// swich 문에는 조건식으로 실수형 변수와 실수형 상수를 사용할 수 없습니다.
