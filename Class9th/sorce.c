...
void Notify(int count)
{
	...
	// 재쉬 함수의 경우 특정한 시점에서 함수를 반환해야 하며,
...
#pragma region 매개 변수
	...
	//// 매개 변수는 함수 내부에서만 연산이 이루어지며, 함수가 종료되면
...
#pragma region 재귀 함수
	...
	// 메모리가 계속 쌓이게 됨으로 스택 오버플로우가 발생합니다.
