...
#pragma region 상수
	...
	//
	//// print( ) 함수로 소수를 출력할 때 4 bate 크기의 실수형
	//// 자료형은 소수점 이하 6자리까지만 표기하며, 8 bite 크기의
...
#pragma region 비트 연산자
	...
	// <AND 연산자>
	// 두 개의 피연산자 가 모두 1이면 1을 반환하는 연산자입니다.
	int x = 10;  // 0000 1010
	char y = 6;   // 0000 0110      0010 2
